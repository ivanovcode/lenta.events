...
<div class="table-responsive">
    <div id="no-more-tables">
        <table class="table">
            ...
            <tbody>
            {%*group*}
            <tr class="js-post" data-id="{*group:id*}">
                <td data-title="Превью:" class="post-preview" style="background-image: url('../../../app/images/default.png')">
                </td>
                <td data-title="Событие:">
                    <span class="post-date">{*group:keywords*}</span><br>
                    {*group:group_title*}<br>
                    <a href="https://vk.com/{*group:group_id*}" target="_blank">подробнее</a>
                </td>
                <td>
